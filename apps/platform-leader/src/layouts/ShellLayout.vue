...
<template>
  <AppShell :groups="navigation" :user-name="auth.user?.displayName ?? '团长'" :role-label="roleLabels[APP_ROLE] ?? APP_ROLE" :current-path="currentPath" @navigate="onNavigate" @logout="onLogout">
    <RouterView />
  </AppShell>
</template>
