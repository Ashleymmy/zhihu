import { buildSignature, injectSignParams } from '../../src/sign/zhihu';
...
describe('知乎签名', () => {
  it('匹配规范 Golden Vector', () => {
    ...
    }, 'a735eb11da74123074675fa3522a90d1')).toBe('794a1d97ffdd4af53c7064d697d686e2da4177bc2ccdcb4168e2f829b0f5c579');
  });

  it('排除分页、二代渠道和 signature', () => {
    const base = { access_token: 'a', keyword: '中 文', timestamp: 1 };
    expect(buildSignature({ ...base, offset: 10, limit: 20, second_channel_id: 'x', signature: 'old' }, 's'))
      .toBe(buildSignature(base, 's'));
  });
